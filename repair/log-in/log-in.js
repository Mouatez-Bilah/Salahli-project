    ...
    if (isValid) {
      try{
        ...
        if(response.status >= 200 && response.status < 300){
          ...
          localStorage.setItem("Rusername", emailInput.value);
          // Store password for profile editing
          localStorage.setItem("RuserPassword", passwordInput.value);
          
          console.log('Stored password:', localStorage.getItem('RuserPassword'));
